...
OSA_CAP/src/%.o: ../OSA_CAP/src/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I/home/nvidia/TrackerPC/include -I../OSA_CAP/inc -I/home/nvidia/TrackerPC/OSA_CAP/inc -I/usr/include/opencv -I../include -O3 -Xcompiler -fPIC -Xcompiler -fopenmp -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_53,code=sm_53 -m64 -odir "OSA_CAP/src" -M -o "$(@:%.o=%.d)" "$<"
	/usr/local/cuda-8.0/bin/nvcc -I/home/nvidia/TrackerPC/include -I../OSA_CAP/inc -I/home/nvidia/TrackerPC/OSA_CAP/inc -I/usr/include/opencv -I../include -O3 -Xcompiler -fPIC -Xcompiler -fopenmp --compile -m64 -ccbin aarch64-linux-gnu-g++  -x c++ -o  "$@" "$<"
